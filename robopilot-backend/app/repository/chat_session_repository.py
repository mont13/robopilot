...
class ChatSessionRepository(BaseRepository):
    ...
    async def get_session_by_id(self, session_id: str) -> DbChatSession | None:
        """
    ...
    async def create_session(self, name: str | None = None) -> DbChatSession:
        """
    ...
    async def update_session_name(self, session_id: str, name: str) -> DbChatSession | None:
        """
    ...
    async def get_active_session(self) -> DbChatSession | None:
        """
