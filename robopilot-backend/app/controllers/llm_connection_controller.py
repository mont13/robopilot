...
class TestConnectionResponse(BaseModel):
    ...
    response: str | None = Field(None, description="Response from the model")
...
async def list_connections(
    ...
    try:
        ...
        logger.error(f"Failed to list connections: {e!s}")
        raise HTTPException(
            status_code=500, detail=f"Failed to list connections: {e!s}"
        )
...
async def create_connection(
    ...
    try:
        ...
        logger.error(f"Failed to create connection: {e!s}")
        raise HTTPException(
            status_code=500, detail=f"Failed to create connection: {e!s}"
        )
...
async def get_connection(
    ...
    try:
        ...
        logger.error(f"Failed to get connection: {e!s}")
        raise HTTPException(status_code=500, detail=f"Failed to get connection: {e!s}")
...
async def update_connection(
    ...
    try:
        ...
        logger.error(f"Failed to update connection: {e!s}")
        raise HTTPException(
            status_code=500, detail=f"Failed to update connection: {e!s}"
        )
...
async def delete_connection(
    ...
    try:
        ...
        logger.error(f"Failed to delete connection: {e!s}")
        raise HTTPException(
            status_code=500, detail=f"Failed to delete connection: {e!s}"
        )
...
async def activate_connection(
    ...
    try:
        ...
        logger.error(f"Failed to activate connection: {e!s}")
        raise HTTPException(
            status_code=500, detail=f"Failed to activate connection: {e!s}"
        )
...
async def get_active_connection(
    ...
    try:
        ...
        logger.error(f"Failed to get active connection: {e!s}")
        raise HTTPException(
            status_code=500, detail=f"Failed to get active connection: {e!s}"
        )
