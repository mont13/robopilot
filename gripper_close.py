...
PROGRAM_CLOSE = "/programs/gripper_close.urp"
...
# 1. Načtení programu
print("\n--- Načítání programu ---")
response_load = send_dashboard_command(f"load {PROGRAM_CLOSE}")
...
if response_load and ("Loading program" in response_load or "File not found" not in response_load):
    ...
    print(
        f"Nepodařilo se načíst program: {PROGRAM_CLOSE}. Zkontrolujte název a cestu.")
