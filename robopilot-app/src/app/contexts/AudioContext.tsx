...
import { selectAudioSettings } from "@/app/lib/features/settings/settingsSlice";
...
export function AudioProvider({ children }: AudioProviderProps) {
  ...
  // Redux state
  const { selectedVoice, speakerId, transcriptionLanguage } =
    useAppSelector(selectAudioSettings);
